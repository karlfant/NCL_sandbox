...
int main(void)
{
	...
	if((alpha = fopen("shift.hex", "r"))==NULL){
		printf("Error: fopen failed.\n");
	}else{
		alphaD0 = fopen("shift0.dual", "w");
		alphaD1 = fopen("shift1.dual", "w");
		alphaD2 = fopen("shift2.dual", "w");
		alphaD3 = fopen("shift3.dual", "w");
		alphaD4 = fopen("shift4.dual", "w");
		alphaD5 = fopen("shift5.dual", "w");
		alphaD6 = fopen("shift6.dual", "w");
		alphaD7 = fopen("shift7.dual", "w");
		alphaD8 = fopen("shift8.dual", "w");
		alphaD9 = fopen("shift9.dual", "w");
		alphaD10 = fopen("shift10.dual", "w");
		alphaD11 = fopen("shift11.dual", "w");
		alphaD12 = fopen("shift12.dual", "w");
		alphaD13 = fopen("shift13.dual", "w");
		alphaD14 = fopen("shift14.dual", "w");
		alphaD15 = fopen("shift15.dual", "w");
		alphaD16 = fopen("shift16.dual", "w");
		alphaD17 = fopen("shift17.dual", "w");
		alphaD18 = fopen("shift18.dual", "w");
		alphaD19 = fopen("shift19.dual", "w");
		alphaD20 = fopen("shift20.dual", "w");
		alphaD21 = fopen("shift21.dual", "w");
		alphaD22 = fopen("shift22.dual", "w");
		alphaD23 = fopen("shift23.dual", "w");
		alphaD24 = fopen("shift24.dual", "w");
		alphaD25 = fopen("shift25.dual", "w");
		alphaD26 = fopen("shift26.dual", "w");
		alphaD27 = fopen("shift27.dual", "w");
		alphaD28 = fopen("shift28.dual", "w");
		alphaD29 = fopen("shift29.dual", "w");
		alphaD30 = fopen("shift30.dual", "w");
		alphaD31 = fopen("shift31.dual", "w");
